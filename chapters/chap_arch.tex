...
Další možností může být použití nějaké \texttt{NoSQL} distribuované databáze, například \textit{MondoDB} \cite{mongodb-scale}. \textit{MondoDB} je dokumentová databáze, kde jednotlivé dokumenty jsou uloženy ve formátu \texttt{BSON}\footnote{Binární forma JSON (z ang. JavaScript Object Notation)}. Mezi hlavní výhody \textit{MondoDB} patří:
\begin{description}
